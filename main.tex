...
information about their configuration of the device and how track-able it is. We would
exploit the data we collect to advise users about how they can be unique when compared
to others and thus, how they can be less track-able. Moreover, we demonstrate how a large
...
scripts that collects information about a remote device accessed through mobile browsers which will be used for
...
\begin{IEEEkeywords}
Mobile Fingerprinting, Sensors, Tracking.
\end{IEEEkeywords}
...
\end{lstlisting}
\noindent\textbox{\hfill listing 1: }\textbox{\hfil Javascript code snippet which uses sensors \hfil}\textbox{\hfill .}\\
\end{enumerate}
...
\end{lstlisting}
\noindent\textbox{\hfill listing 2: }\textbox{\hfil Code for Detecting Android Smart phones \hfil}\textbox{\hfill .}\\
\begin{verbatim}
